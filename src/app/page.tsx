...
import { ChefHat, ListChecks, RefreshCw, Calendar, ArrowLeft, ArrowRight, PlusSquare, AlertTriangle, Trash2, Check, FileText, PanelLeftOpen, PanelRightOpen, X } from "lucide-react"; // Added X
